...
document.querySelector("#createdBy").innerHTML = "Aplicación creada por: Mati"
...
function buildToDos(toDos) {
  // Tu código acá:
   let arrayToDos = toDos.map(function (todo, i) {
...
function displayToDos() {
  // Tu código acá:
   ...
   let arrayBuildToDos = buildToDos(toDoItems);
   for (let i = 0; i < arrayBuildToDos.length; i++) {
      toDoContainer.appendChild(arrayBuildToDos[i]);
   } 
}
